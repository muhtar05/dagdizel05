...
abstract class Image_Driver {
	...
	protected $tmp_image;
        ...
        // Ссылка на изображение для подписи фотографии
        protected $waterMarkImgUrl;
	...
	abstract public function sharpen($amount);
         ...
         * 
         * @param string $waterMarkImgUrl
         * @return boolean 
         */
        abstract public function waterMark($waterMarImgUrl, $realImg);
