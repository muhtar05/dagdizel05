...
/**
 * This is the model class for table "{{tournament_guest}}".
 *
 * The followings are the available columns in table '{{tournament_guest}}':
 * @property integer $id
 ...
 */
class TournamentGuest extends CActiveRecord
{
	/**
...
//			// @todo Please remove those attributes that should not be searched.
	 ...
	 * @return TournamentGuest the static model class
	 */
