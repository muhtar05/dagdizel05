...
class PersonalController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','rucovodstvo'),
				'users'=>array('*'),
			),
	...
	public function actionIndex()
	{
        ...
        $criteria->condition = 'personal_type='.Personal::PERSONAL_PERSONAL;
    ...
    public function actionRucovodstvo()
    {
        $this->layout = '//layouts/column1';
        $criteria = new CDbCriteria();
        $criteria->condition = 'personal_type='.Personal::PERSONAL_LEADING;

        $dataProvider=new CActiveDataProvider('Personal',array(
            'criteria'=>$criteria,
        ));

        $this->render('rucovodstvo',array(
            'dataProvider'=>$dataProvider,
        ));
